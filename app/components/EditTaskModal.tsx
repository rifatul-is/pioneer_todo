...
export default function EditTaskModal({ isOpen, onClose, task, onSubmit, onDelete }: EditTaskModalProps) {
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-200">
            ...
            <button
              ...
              disabled={isSubmitting || isDeleting}
              className="w-12 h-12 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
